...
Details, advantages,and disadvantages of using trees as data structures. Qualifying trees as well as how to traverse them. Implementing binary, binary search, AVL, and Max Binary Heap trees.
